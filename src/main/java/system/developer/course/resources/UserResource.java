...
import system.developer.course.services.UserService;
...
public class UserResource {
	...
	@GetMapping(value = "/{id}")
	public ResponseEntity<User>findById(@PathVariable Long id){//PARA O SPRING RECONHECER A VARIAVEL Q VEIO PELA URL
