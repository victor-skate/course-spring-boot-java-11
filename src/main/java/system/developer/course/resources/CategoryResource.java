...
import system.developer.course.services.CategoryService;
...
public class CategoryResource {
	...
	@GetMapping(value = "/{id}")
	public ResponseEntity<Category>findById(@PathVariable Long id){//PARA O SPRING RECONHECER A VARIAVEL Q VEIO PELA URL
